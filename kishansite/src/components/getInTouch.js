    ...
    return (<div style={{width:'100%'}}>
        ...
        <div className={"contactContainer"}>
            <div className={"contactLeft"}>
                ...
                <p> Feel free to email me at: <a href="mailto:kishan@kishant.nl" className={"link"}>kishan@kishant.nl</a> or <a href="mailto:kishanthakurani2003@gmail.com" style={{color:"white"}}>kishanthakurani2003@gmail.com</a> </p>
